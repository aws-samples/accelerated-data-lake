...
* Enter the environment prefix, in this case: wildrydes-dev-
* Change the other parameters as per requirements / best practise. The default values will provision a single instance t2.medium node - this is adaquate for low tps dev and testing.
